...
int Shaders::Init(char * fileVertexShader, char * fileFragmentShader)
{
	...
	//Water
	uniformDepthAdjust = glGetUniformLocation(program, "u_depthAdjust");
	uniformFresnelPower = glGetUniformLocation(program, "u_fresnelPower");
	uniformWaterColor = glGetUniformLocation(program, "u_waterColor");
	return error;
}
